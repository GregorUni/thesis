...
sudo ip macsec add macsec0 tx sa 0 pn 1 on key 02 09876543210987654321098765432$
sudo ip macsec add macsec0 rx address ec:b1:d7:4b:bd:01 port 1
sudo ip macsec add macsec0 rx address ec:b1:d7:4b:bd:01 port 1 sa 0 pn 1 on key$
