...
eva() {
	...
	if [[ $5 == mwe ]]; then
		echo -e "Ich war hier"
		IP=$DEST_IP
		ssh root@$REMOTE_IP "sh /home/test-2/config_macsec_without_encryption.sh"
		...
		IP=$DEST_IP
		ssh root@$REMOTE_IP "sh /home/test-2/config_macsec_encryption_default.sh"
		...
		IP=$DEST_IP
		ssh root@$REMOTE_IP "sh /home/test-2/config_macsec_chacha_without_encryption.sh"
		...
		IP=$DEST_IP
		ssh root@$REMOTE_IP "sh /home/test-2/config_macsec_chacha_encryption.sh"
		config_macsec_chacha_without_encryption
		make_info $2 $4
		eva_ping $2 $4 $IP
		eva_iperf $1 $2 $4 $DEST_IP
		...
		IP=$DEST_IP
		ssh root@$REMOTE_IP "sh /home/test-2/config_macsec_aegis128l_without_encryption.sh"
		...
		IP=$DEST_IP
		ssh root@$REMOTE_IP "sh /home/test-2/config_macsec_morus640_without_encryption.sh"
...
config_macsec_aegis128l_without_encryption()
{
	...
	sudo ip link add link enp0s3 macsec0 type macsec cipher aegis128l-128
	sudo ip macsec add macsec0 tx sa 0 pn 1 on key 01 12345678901234567890123456789012
	sudo ip macsec add macsec0 rx address 08:00:27:19:58:33 port 1
	sudo ip macsec add macsec0 rx address 08:00:27:19:58:33 port 1 sa 0 pn 1 on key 02 09876543210987654321098765432109
	sudo ip link set dev macsec0 up
...
eva 4 "macsec-aes(gcm)-we" 1000 1468 mwe
eva 4 "macsec-aes(gcm)-e" 1000 1468 med
eva 4 "macsec-chachapoly-we" 1000 1468 cwe
eva 4 "macsec-chachapoly-e" 1000 1468 mce
eva 4 "macsec-aegis128l-we" 1000 1468 awe
eva 4 "macsec-morus640-we" 1000	1468 mmwe
